 ...
 * @version: 1.0
 */
public class PluginFreeMarkerView extends AbstractTemplateView {
    ...
    protected void initServletContext(ServletContext servletContext) throws BeansException {
        ...
        PluginFreeMarkerConfig config = autodetectConfiguration();
     ...
     * @return the Configuration instance to use for PluginFreeMarkerViews
     * @throws BeansException if no Configuration instance could be found
     * @see #getApplicationContext
     * @see #setConfiguration
     */
    protected PluginFreeMarkerConfig autodetectConfiguration() throws BeansException {

        try {

            return BeanFactoryUtils.beanOfTypeIncludingAncestors(
                    obtainApplicationContext(), PluginFreeMarkerConfig.class, true, false);
    ...
    private class DelegatingServletConfig implements ServletConfig {
        ...
        public String getServletName() {
            return PluginFreeMarkerView.this.getBeanName();
        }

        @Override
        @Nullable
        public ServletContext getServletContext() {
            return PluginFreeMarkerView.this.getServletContext();
        }
